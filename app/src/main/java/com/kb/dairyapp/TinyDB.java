...
public class TinyDB {
    ...
    public void putListEvent(String key, ArrayList<EventDetail> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(EventDetail player: playerList){
            objStrings.add(gson.toJson(player));
        }
        putListString(key, objStrings);
    }
    public ArrayList<EventDetail> getListEvent(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<EventDetail> playerList =  new ArrayList<EventDetail>();

        for(String jObjString : objStrings){
            EventDetail player  = gson.fromJson(jObjString,  EventDetail.class);
